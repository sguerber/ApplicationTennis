...
<!-- L'ajout de " method="post" action="ajouterjoueur" " dans la balise form permet d'exécuter la méthode doPost() de ajouterjoueur après clic sur le bouton -->
<form class="needs-validation "  novalidate method="post" action="ajouterjoueur">
  ...
  <div class="form-row">
	<div class="col-md-4 mb-3">
	  ...
	  <input type="text" name="txtPrenom" class="form-control" style="width:400px;" id="validationCustom02"  required>
	  <div class="valid-feedback">
       Très bien!
     </div>
	</div>
