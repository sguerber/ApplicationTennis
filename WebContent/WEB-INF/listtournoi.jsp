...
<div style="    padding: 1.5rem;    margin-right: 0;    margin-left: 0;    border-width: .2rem;">
	<a class="btn btn-primary" href="/AppliJoueurs/ajoutertournoi" role="button">Ajouter tournoi</a>
</div>
<table class="table">
  <thead>
    <tr>
  ...
  <tbody>
	...
	<%@ include file="menutournoi.jsp" %>
     ...
     <c:if test="${nboccurrence == 0}">
     	<tr>
     		<!--    Le colspan="5" permet au message de prendre la largeur des 4 colonnes dans le tableau et s'affiche au centre de celles-ci grâce au "text-align:center" -->
     ...
     <c:forEach var="tournoi" items="${tournois}"> 
		<!--   Méthode doGet() de modifiertournoi pour récupérer l'id du tournoi et afficher la page pour modifier le tournoi -->
