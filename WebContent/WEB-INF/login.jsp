<html lang="fr">
  ...
  <body style="background-color:#000000 ;">
	<!--   	Quand on clique sur le bouton 'submit' ça appelle la méthode doPost de la servlet Login -->
    <form method="post" action="login" >
	  <img class="mb-4" src="logo.png" alt="">
	  <h1 class="h3 mb-3 font-weight-normal" style="color:#FFF;">Please sign in</h1>
	  <label for="inputEmail" class="sr-only" >Email address</label>
	  <input type="email" id="inputEmail" name="txtLogin" class="form-control" placeholder="Adresse mail" required autofocus>
